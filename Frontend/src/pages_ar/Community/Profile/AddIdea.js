...
import { addIdeaAr, reset } from "../../../features_ar/profile/profileSlice";
    ...
    return (
        <>
            <form onSubmit={handleSubmit}>
                <p className="card__subtitle">فكرة التسمية التوضيحية</p>
                <TextField
                    fullWidth
                    type="text"
                    name="text"
                    ...
                    required
                />
                <p className="card__subtitle">صور الفكرة</p>
