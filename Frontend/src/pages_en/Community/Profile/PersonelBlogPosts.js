...
import { searchBlogPostsByIdEn, sendMessageEn, sendLikeEn, deleteBlogPostEn } from '../../../features_en/blogpost/blogpostSlice';
...
const PersonelBlogPosts = ({ handleStep }) => {
    ...
    useEffect(() => {
        dispatch(searchBlogPostsByIdEn({ profileId: user.profile._id }));
                                ...
                                <div className="interaction">
                                    <div
                                        onClick={() => {
                                            ...
                                            dispatch(sendLikeEn({ blogpostId: blogpost._id, like: "like", profileId: user.profile._id }))
                                        }}
                                    >
                                        <Tooltip title="Like">
                                    ...
                                    <div
                                        onClick={() => {
                                            dispatch(deleteBlogPostEn({ profileId: user.profile._id, blogpostId: blogpost._id }))
                                        }}
                                    >
